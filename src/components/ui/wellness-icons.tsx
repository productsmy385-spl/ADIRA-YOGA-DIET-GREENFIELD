...
export function YogaIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 9v4m0 0l-3 5m3-5l3 5" />
      <path d="M6 13c3-1 6-1 9 0" />
      <path d="M4 18c4-1.5 8-1.5 12 0" />
    </svg>
  );
}
...
export function MeditationIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 10v4" />
      <path d="M7 16c2-1 4-1.5 5-1.5s3 .5 5 1.5" />
      <path d="M5 20c3.5-1 10.5-1 14 0" />
    </svg>
  );
}
...
export function BreathingIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6 9c2-2 4.5-2 6.5 0s4.5 2 6.5 0" />
      <path d="M4 13c2.5-2.5 5.5-2.5 8 0s5.5 2.5 8 0" />
      <path d="M7 17c1.5-1.5 3.5-1.5 5 0s3.5 1.5 5 0" />
    </svg>
  );
}
...
export function DietIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 6a6 6 0 0 1 6 6h-6z" />
    </svg>
  );
}

export function MealsIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M18 2v20M18 6a4 4 0 0 0 0 8M6 2v6a3 3 0 0 0 6 0V2M9 11v11" />
    </svg>
  );
}
...
export function NutritionIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 22C6.5 22 4 17 4 12c0-3.5 2-6.5 5-8 1.5 2 4 3 7 3 2 0 3-1 4-2 0 4.5-2 8.5-5 12-1 1.5-2 3-3 5z" />
      <path d="M12 22V10" />
    </svg>
  );
}
...
export function WorkoutIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6.5 6.5h11M6.5 17.5h11M3 9.5h18M3 14.5h18M2 8v8M22 8v8" />
    </svg>
  );
}
